...
public partial class New_Design_Admin : System.Web.UI.Page
{
    SqlConnection cn;
    SqlCommand cmd;
    SqlDataAdapter da;
      ...
      /*  string ddim="select date,image from dailydarshan";
        ...
        */
                ...
                try
                {
                    ...
                    string auto11 = "select max(id) from DailyDarshan";
                ...
                string qq;
                qq = "insert into DailyDarshan values('" + auto + "','" + n22 + "','" + date1 + "')";
