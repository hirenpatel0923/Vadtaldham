...
public partial class AdminMobileInsert : System.Web.UI.Page
{
    SqlConnection cn;
    SqlCommand cmd;
    SqlDataAdapter da;
    ...
    protected void Button2_Click(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            string auto11 = "select max(id) from MobileWallpaper";
        ...
        string qq;
        qq = "insert into MobileWallpaper values('" + auto + "','" + n22 + "','" + date1 + "')";
