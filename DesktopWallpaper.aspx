<%@ Page Title="" Language="C#" MasterPageFile="~/Database.master" AutoEventWireup="true" CodeFile="DesktopWallpaper.aspx.cs" Inherits="DesktopWallpaper" %>
...
<td runat="server" />
    ...
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
        ...
        SelectCommand="SELECT [image] FROM [DeskWallpaper]"></asp:SqlDataSource>
