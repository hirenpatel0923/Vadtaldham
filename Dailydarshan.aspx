<%@ Page Title="" Language="C#" MasterPageFile="~/Database.master" AutoEventWireup="true" CodeFile="Dailydarshan.aspx.cs" Inherits="New_Design_Dailydarshan" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <ItemTemplate>
        <td align="center">
	        ...
	        <section id="examples" class="section examples-section">
				<a class="example-image-link" href='<%#Eval("image") %>' data-lightbox="example-set" ><img class="example-image" src='<%#Eval("image") %>' alt="Plants: image 1 0f 4 thumb" width="150" height="150"></a>
	        </section>
    <script>
        var _gaq = _gaq || [];
 ...
 <br />
     ...
     <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
         ...
         SelectCommand="SELECT [image] FROM [DailyDarshan] WHERE ([date] = @date)">
         <SelectParameters>
