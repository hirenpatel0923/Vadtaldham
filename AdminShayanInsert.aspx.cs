...
public partial class AdminShayanInsert : System.Web.UI.Page
{
    SqlConnection cn;
    SqlCommand cmd;
    SqlDataAdapter da;
      ...
      /*  string ddim="select date,image from dailydarshan";
        ...
        */
                ...
                try
                {
                    ...
                    string auto11 = "select max(id) from ShayanDarshan";
                ...
                string qq;
                qq = "insert into ShayanDarshan values('" + auto + "','" + n22 + "','" + date1 + "')";
